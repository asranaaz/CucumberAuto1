...
public class backgroundStepDef {
    ...
    @Given("User should be on facebook login page")
    public void userShouldBeOnFacebookLoginPage() {
    }

    @When("User enters user {string} first name")
    public void userEntersUserFirstName(String arg0) {
    }
    ...
    public void userMobileFieldShouldBeBlank() {

    }

    @And("User enters user {string} surname")
    public void userEntersUserSurname(String arg0) {
    ...
    @Then("User checks user{string} first name Ryan is present")
    public void userChecksUserFirstNameRyanIsPresent(String arg0) {
    }
}
